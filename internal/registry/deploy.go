...
func deployCreate() Command {
	return Command{
		...
		OutputFields: []Field{
			...
			{Name: "team", Type: "object", Description: "{id, slug}"},
			{
				Name: "status",
				Type: "string",
			...
			{Name: "changed", Type: "bool", Description: "always true; every call starts a new build"},
			{Name: "startedAt", Type: "string", Description: "RFC 3339"},
			{Name: "url", Type: "string | null", Description: "public URL, once the app has a public HTTP port"},
		},
		...
		Examples: []Example{
			...
			},
			{
				...
				OutputSample: map[string]any{
					...
					"url":          "https://checkout-8080-acme.outplane.app",
				},
			},
		},
